/* This is the original BasePlayer generated by Expression Encoder. It is unchanged with the exception of formatting. */
...
Ee.UI.Xaml.Control.prototype = {
    ...
    set_scaleMode: function(a) {
        this._scaleMode = a;
        if (this._xamlInitialized && a !== Ee.UI.Xaml.ScaleMode.none)
    ...
    _ensureTransform: function() {
        ...
        a = Ee.UI.Xaml.Control._computeScale(b),
        c,
        d;
    ...
    _xamlError: function(b, c) {
        var a = this.get_element();
        if (a)
            this._raiseXamlError(b, new Ee.UI.Xaml.ErrorEventArgs(c))
        },
...
Ee.UI.Xaml.Control._ensureScale = function(b, c, d) {
    ...
    if (!a)
        b.RenderTransform = a = b.getHost().content.createFromXaml('<ScaleTransform ScaleX="1" ScaleY="1"/>');
    a.ScaleX = c;
    a.ScaleY = d
};
...
Ee.UI.Xaml.Media._Button = function(h, a, e, g, c, b, f) {
    ...
    if (b) {
        ...
        if (c)
            this._doubleClickDelegate = Function.createDelegate(b, c)
        }
};
...
Ee.UI.Xaml.Media.Player.prototype = {
    ...
    _meBufferingProgress: function() {
        var b = this._mediaElement.bufferingProgress,
        a = Math.round(b * 100);
        if (a >= 100)
